...
$poster      = $hero_video['poster'] ?? '/wp-content/uploads/2026/04/houston-video-poster.jpg';

// Flat subfields of Video Section
$logo            = $vs['hero_logo']              ?? '/wp-content/uploads/2026/02/White_Verticle_TTLogo.png';
$heading_top     = $vs['hero_top_heading']       ?? 'Houston\'s Ultimate';
...
(function () {
  function loadHeroVideo() {
    var video = document.querySelector('.hero__video[data-src]');
    if (!video) return;
