<?php
/**
 * Houston Ticket Warning Modal
 * Compatible with dynamically rendered React buttons.
 */
?>

<div id="houston-warning-modal" class="park-warning-modal" aria-hidden="true">
	<div
		class="park-warning-modal__content"
		role="dialog"
		aria-modal="true"
		aria-labelledby="houston-warning-title"
	>
		...
		<h3 id="houston-warning-title">
			This Ticket Is for Houston
		</h3>

		<p>
			You are about to purchase tickets for the Houston park location.
			If you are looking for Austin tickets instead, use the button below.
		</p>

		<div class="park-warning-modal__actions">

			<a
				href="<?php echo esc_url( home_url( '/austin/' ) ); ?>"
...
document.addEventListener('DOMContentLoaded', function () {
	...
	const modal = document.getElementById('houston-warning-modal');
	const continueButton = document.getElementById('houston-warning-continue');
	...
	document.addEventListener('click', function(event) {
		 ...
		 */
		if (
			addToCartButton.id === 'houston-warning-continue' ||
			addToCartButton.closest('#houston-warning-modal')
		) {
			return;
		}
		 ...
		 */
		if (addToCartButton.dataset.houstonConfirmed === 'true') {
			addToCartButton.dataset.houstonConfirmed = 'false';
			return;
		}
	...
	continueButton.addEventListener('click', function() {
		 ...
		 * Prevent modal loop
		 */
		activeCartButton.dataset.houstonConfirmed = 'true';
