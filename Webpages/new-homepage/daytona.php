...
$video_mp4   = $hero_video['mp4']    ?? '/wp-content/uploads/2026/05/Daytona-Lagoon-Website-Video.mp4';
$video_webm  = $hero_video['webm']   ?? '/wp-content/uploads/2026/05/Daytona-Lagoon-Website-Video.webm';
$poster      = $hero_video['poster'] ?? '/wp-content/uploads/2026/05/dayton-video-poster.jpg';

// Flat subfields of Video Section
$logo            = $vs['hero_logo']              ?? '/wp-content/uploads/2026/02/White_Verticle_TTLogo.png';
$heading_top     = $vs['hero_top_heading']       ?? 'Daytona\'s Ultimate';
$heading_styled  = $vs['hero_subheading_styled'] ?? 'Adventure';
...
$button_url  = $hero_button['url']  ?? 'https://dlagoon.centeredgeonline.com/retail/items/g/MainPage';
