    ...
    for ($day = 1; $day <= $days_in_month; $day++) {
      ...
      $status_class = 'closed';
        ...
        if ($info) {
            ...
            if (!empty($info['notes']) && $weather_status === 'Normal') {
