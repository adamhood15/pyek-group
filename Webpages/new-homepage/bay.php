...
$video_mp4  = $hero_video["mp4"]  ?? "/wp-content/uploads/2026/04/CBB-Web.mp4";
$video_webm = $hero_video["webm"] ?? "/wp-content/uploads/2026/04/CBB-Web.webm";

$poster_field = $hero_video["poster_desktop"] ?? [];

$poster        = $poster_field["url"]    ?? "/wp-content/uploads/2026/04/bay-poster-desktop.jpg";
...
// Headings
$heading_top    = $video_section["hero_top_heading"]       ?? "VEGAS\u{2019}S ULTIMATE";
...
$button_url  = $hero_button["url"]  ?? "https://cowabungavegas.com/bay/buy-tickets/";
?>
...
<section class="hero" style="position:relative;height:100vh;overflow:hidden;">
  ...
  <div class="hero__overlay">
    ...
    <a href="<?php echo esc_url($button_url); ?>" class="nz-button-blue">
